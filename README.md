This repo contains license plate detection and text recognition with various object detection models. License plates are recognized and the characters are extracted with `pytesseract` OCR library
